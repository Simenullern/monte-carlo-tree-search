...
def move_from_distribution(distribution_normalized, board_size, verbose=False):
...
def max_move_from_distribution(distribution_normalized, board_size, verbose=False):
